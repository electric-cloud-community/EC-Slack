...
class EC-SlackRESTClient {

    private static String BEARER_PREFIX = 'Bearer'
    private static String USER_AGENT = 'EC-SlackRESTClient REST Client'
    ...
    EC-SlackRESTClient(String endpoint, RESTConfig restConfig, FlowPlugin plugin) {
    ...
    /**
     * Will create a EC-SlackRESTClient object from the plugin Config object.
     * Convenient as it can use pre-defined configuration fields.
     */
    static EC-SlackRESTClient fromConfig(Config config, FlowPlugin plugin) {
        Map params = [:]
        ...
        return new EC-SlackRESTClient(endpoint, restConfig, plugin)
    }
    ...
    * text: in query
    */
    def SendRealtimeMessage(Map<String, String> params) {
        ...
        query.put('channel', params.get('channel'))

        query.put('text', params.get('text'))
...
// DO NOT EDIT THIS BLOCK === rest client ends, checksum: f487f58ca45a463f99b6288bc62cf5d6 ===
    /**
